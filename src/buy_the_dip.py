...
### Try to Pull API data three times   
    for i in range(3):
        try:
            get_yahoo_historical.get_ytd(stonk)
            break
        except Exception as e:
            print('###########YAHOO API FAILURE#########')
            print(e)
            print(i)
            print('###########YAHOO API FAILURE#########')
            time.sleep(60)
...
### Try to Login and Pull API data once every minute for 60 minutes  
    for i in range(60):
        try:
            ...
            close_list_one = TDAPI.get_close_list(TDSession,stonk,1,5)
...
### Loop that checks stock prices every 5 minutes, appends price to rolling average, and cycles 168 times 
    for i in range(268):
        ...
        try:
            ...
            print('###########TDA API FAILURE#########')
            pass
### Loop that checks stock prices every 29 seconds and cycles 10 times 
        for t in range(10): 
